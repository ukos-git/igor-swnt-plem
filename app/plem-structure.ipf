...
Function PLEMd2statsLoad(stats, strMap)
	...
	Wave stats.wavMeasure 		= createWave(dfrMap, "MEASURE", setWaveType = PLEMd2WaveTypeUnsigned)
	Wave stats.wavIBW 			= createWave(dfrMap, "IBW")
	Wave stats.wavBackground 	= createWave(dfrMap, "BACKGROUND", setWaveType = PLEMd2WaveTypeUnsigned)
